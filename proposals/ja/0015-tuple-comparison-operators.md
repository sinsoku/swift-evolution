...
* 提案: [SE-0015](https://github.com/apple/swift-evolution/blob/master/proposals/0015-tuple-comparison-operators.md)
* 提案者: [Kevin Ballard](https://github.com/kballard)
* 状況: **Swift 2.2 実装済み** ([Pull request](https://github.com/apple/swift/pull/408))
* レビュー責任者: [Dave Abrahams](https://github.com/dabrahams)

## 背景

いくつかの項数までのタプルで比較演算子を実装する。
